...
$sql = "SELECT * FROM students WHERE s_id = {$_GET['target']}";
    ...
    <div id="wrapper" class="wrapper bg-ash">
        ...
        <div class="dashboard-page-one">
            ...
            <div class="dashboard-content-one">
                ...
                <div style="margin: 10px auto;" class="card height-auto">
                    <div id="preloader2" style="display: none"></div>
                    <div class="card-body">
                        <div class="heading-layout1">
                            <div class="item-title">
                                <h3>Updating Students Info</h3>
                            </div>
                        </div>
                        <form class="new-added-form customForm">
                            <input type="hidden" name="act" value="updateStudent">
                            <input type="hidden" name="s_id" value="<?php echo $results['s_id']?>">
                            <div class="row">
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>First Name *</label>
                                    <input name="s_fName" type="text" placeholder="" class="form-control" value="<?php echo $results['s_fName'];?>">
                                    <span class="formSpan" id="s_fName">Unknown</span>
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Last Name *</label>
                                    <input name="s_lName" type="text" placeholder="" class="form-control" value="<?php echo $results['s_lName'];?>">
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <script>
                                        $("option[value='<?php echo $results['s_gender'];?>']").attr("selected", "selected");
                                    </script>
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Date Of Birth *</label>
                                    <input name="s_dob" type="text" placeholder="yyyy-mm-dd" class="form-control air-datepicker" value="<?php echo $results['s_dob'];?>"
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <script>
                                        $("option[value='<?php echo $results['s_religion'];?>']").attr("selected", "selected");
                                    </script>
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Nationality</label>
                                    <input name="s_nationality" type="text" placeholder="" class="form-control" value="<?php echo $results['s_nationality'];?>">
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <script>
                                        $("option[value='<?php echo $results['s_class'];?>']").attr("selected", "selected");
                                    </script>
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Emgergency Contact</label>
                                    <input name="s_homTelNum" type="text" placeholder="" class="form-control" value="<?php echo $results['s_homTelNum'];?>">
                                ...
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <script>
                                        $("option[value='<?php echo $results['s_fatherName'];?>']").attr("selected", "selected");
                                    </script>
                                </div>
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <script>
                                        $("option[value='<?php echo $results['s_motherName'];?>']").attr("selected", "selected");
                                    </script>
                                </div>
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                <label>Guardian's Name(if Any)</label>
                                    ...
                                    <script>
                                        $("option[value='<?php echo $results['s_guardianName'];?>']").attr("selected", "selected");
                                    </script>
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Doctor's Full Name</label>
                                    <input name="s_docName" type="text" placeholder="" class="form-control" value="<?php echo $results['s_docName'];?>">
                                    <span class="formSpan" id="s_docName">Unknown</span>
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Doctor's Telephone Number</label>
                                    <input name="s_docTel" type="text" placeholder="" class="form-control" value="<?php echo $results['s_docTel'];?>">
                                    <span class="formSpan" id="s_docTel">Unknown</span>
                                </div>
                                <div class="col-lg-6 col-12 form-group">
                                    <label>Date Of Admission *</label>
                                    <input name="s_doa" type="text" placeholder="yyyy-mm-dd" class="form-control air-datepicker" value="<?php echo $results['s_doa'];?>"
                                        data-position='bottom right'>
                                    <i class="far fa-calendar-alt"></i>
                                ...
                                <div class="col-lg-6 col-12 form-group">
                                    ...
                                    <textarea class="textarea form-control" name="s_info" id="form-message" cols="10"
                                        rows="9"><?php echo $results['s_info']?></textarea>
                                    <span class="formSpan" id="s_info">Unknown</span>
                                </div>
                                <div class="col-lg-6 col-12 form-group mg-t-30">
                                    <img style="height: 100px; width: 100px" src="img/customImg/<?php echo $results['s_photo']?>">
