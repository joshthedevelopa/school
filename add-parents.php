                        ...
                        <form class="new-added-form customForm">
                            ...
                            <div class="row">
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <input name="p_fName" type="text" placeholder="" class="form-control">
                                    <span class="formSpan" id="p_fName">U</span>
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Last Name *</label>
                                    <input name="p_lName" type="text" placeholder="" class="form-control">
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <input name="p_job" type="text" placeholder="" class="form-control">
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Phone *</label>
                                    <input name="p_phone" type="text" placeholder="" class="form-control">
                                    <span class="formSpan" id="p_phone">U</span>
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Nationality </label>
                                    <input name="p_nationality" type="text" placeholder="" class="form-control">
                                    <span class="formSpan" id="p_nationality">U</span>
                                </div>
                                <div class="col-lg-6 col-12 form-group">
                                    <label>Address *</label>
                                    <textarea name="p_address" class="textarea form-control" id="form-message" cols="10" rows="9"></textarea>
                                    <span class="formSpan" id="p_address">U</span>
                                </div>
                                <div class="col-lg-6 col-12 form-group">
                                    <label>Short BIO</label>
                                    <textarea name="p_info" class="textarea form-control" id="form-message" cols="10" rows="9"></textarea>
