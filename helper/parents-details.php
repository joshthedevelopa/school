...
<!-- Mirrored from www.radiustheme.com/demo/html/psdboss/akkhor/akkhor/parents-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Aug 2019 14:38:38 GMT -->
                    ...
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                        ...
                        <li class="nav-item sidebar-nav-item">
                            ...
                            <ul class="nav sub-group-menu sub-group-active">
                                ...
                                <li class="nav-item">
                                    <a href="parents-details.html" class="nav-link menu-active"><i class="fas fa-angle-right"></i>Parents Details</a>
                                </li>
                                <li class="nav-item">
