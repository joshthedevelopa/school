...
<!-- Mirrored from www.radiustheme.com/demo/html/psdboss/akkhor/akkhor/hostel.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Aug 2019 14:38:39 GMT -->
               ...
               <div class="mobile-sidebar-header d-md-none">
                ...
                <div class="sidebar-menu-content">
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                        ...
                        <li class="nav-item">
                            <a href="hostel.html" class="nav-link menu-active"><i class="flaticon-bed"></i><span>Hostel</span></a>
                        </li>
                        <li class="nav-item">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input">
                                                        <label class="form-check-label">Girls - 102</label>
                                                    </div>
                                                </td>
                                                <td>HT-4016</td>
                                                <td>Small</td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input">
                                                        <label class="form-check-label">Boys - 105</label>
                                                    </div>
                                                </td>
                                                <td>HT-5016</td>
                                                <td>Medium</td>
